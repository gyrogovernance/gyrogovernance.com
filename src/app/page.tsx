    ...
    <div className="relative z-10 p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-3 max-w-md mx-auto">
          <Link
            href="/articles/fable-5_thm-report"
            ...
            aria-label="Read THM report: Claude Fable 5 System Prompt (Anthropic)"
          >
            <span className="text-lg font-bold text-foreground transition-colors">Claude Fable 5</span>
          </Link>
          <Link
