    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">3. Google Analytics</h2>
            <p className="text-foreground-secondary mb-4">
          ...
          <section>
            ...
            <p className="text-foreground-secondary mb-4">
              For detailed information about our cookie usage, please see our <a href="/cookie-policy" className="text-apple-blue hover:text-apple-purple underline">Cookie Policy</a>.
            </p>
          </section>
