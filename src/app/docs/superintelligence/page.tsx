...
export default async function SuperintelligencePage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-4xl font-bold mb-8 text-foreground">Superintelligence Documentation</h1>
      ...
      <div className="space-y-4">
        {docs.map((doc) => {
              ...
              <div key={doc.slug} className="space-y-2">
                ...
                <div className="ml-4 space-y-2">
                  {doc.children.map((child) => (
                    <Link
                      key={child.slug}
                      href={`/docs/superintelligence/${doc.slug}/${child.slug}`}
          ...
          return (
            <Link
              key={doc.slug}
              href={`/docs/superintelligence/${doc.slug}`}
