...
export async function generateStaticParams() {
  ...
  try {
    const docsDir = path.join(process.cwd(), 'src', 'content', 'docs', 'superintelligence');

    // Check if directory exists
    if (!fs.existsSync(docsDir)) {
      console.warn('Superintelligence docs directory not found');
      return params;
    }
    ...
    getAllFiles(docsDir);
    console.log(`Generated ${params.length} static params for superintelligence`);
