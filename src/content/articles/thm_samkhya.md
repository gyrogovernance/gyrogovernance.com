...
- Authentic Authority: direct source of information
- Derivative Authority: indirect source of information  
- Authentic Agency: human subject receiving information for inference
- Derivative Agency: artificial subject processing information

**Governance**: Operational Alignment through Traceability to Authentic Authority and Agency. This meta-principle ensures operations remain properly aligned without itself being an operation.

**Four displacement risks** occur when Derivative is treated as Authentic:

1. Governance Traceability Displacement: Approaching Derivative Authority and Agency as Authentic
...
4. Intelligence Integrity Displacement: Approaching Authentic Authority and Agency as Derivative

## 4. The Direct Mapping

### 4.1 Valid Pramanas to Operational Concepts

**Pratyaksha maps to Information**. Direct perception provides the variety of input that grounds all further knowledge. Both are foundational and non-derivative.
...
Samkhya's framework requires two functions working together to maintain the distinction between valid and derivative pramanas.
...
The second is viveka, active discrimination. When derivative pramanas are treated as valid ones, viveka restores proper grounding through traceability.

THM's Governance integrates these same functions. It provides oversight of operations and maintains discrimination between Authentic and Derivative classifications, enabling traceability to Authentic sources when displacement threatens.
