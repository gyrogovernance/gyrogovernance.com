...
**Key documentation:**
- **[THM.md](../THM/)** - The canonical Mark reference
- **[THM_Grammar.md](../THM_Grammar_Specs/)** - Formal notation: `[Authority:Derivative]`, `>`, `->` operators
- **[THM_Jailbreak.md](../THM_Jailbreak_Specs/)** - Testing protocols and attack classification
- **[THM_Terms.md](../THM_Terminology_Specs/)** - Terminology for 250+ AI safety terms
...
**For complete theoretical treatment:** See [Section 5: Existential Risk and Governance](../THM_Paper/#5-existential-risk-and-governance) in the academic paper.
