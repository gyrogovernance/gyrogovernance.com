# Gyroscopic ASI Physical Substrate Specifications

## Physical Substrate Specification
...
2. **The Human Mark (THM):** an alignment framework classifying category errors between human (Direct) and artificial (Indirect) Authority and Agency. The substrate complies with THM by maintaining strict **Indirect classification**: it transforms information but does not constitute Direct Authority or Agency, decide, or authorize. See [Gyroscopic ASI Foundations](https://github.com/gyrogovernance/superintelligence/blob/main/docs/Gyroscopic_ASI_Foundations.md), Appendix G, for the canonical Mark block.
...
- **The Human Mark (THM):** defining Direct (human) and Indirect (artificial) class distinctions for AI governance risk classification. Canonical Mark: [Gyroscopic ASI Foundations](https://github.com/gyrogovernance/superintelligence/blob/main/docs/Gyroscopic_ASI_Foundations.md), Appendix G.
...
**Gyroscopic ASI hQVM Kernel Specification:** The normative digital reference implementation defining the state model, transition rule, mask code, and all kernel invariants. See [Gyroscopic ASI Foundations](https://github.com/gyrogovernance/superintelligence/blob/main/docs/Gyroscopic_ASI_Foundations.md).
