...
export const theme: ThemeUserConfig = {
  ...
  title: 'Gyro Governance',
  /** Will be used in index page & copyright declaration */
  author: 'Gyro Governance',
  /** Description metadata for your website. Can be used in page metadata. */
  description: 'AI Research and Development - Advancing AI governance through innovative research and development solutions',
  ...
  footer: {
    ...
    social: { 
      github: 'https://github.com/gyrogovernance',
      x: 'https://twitter.com/gyrogovernance'
    }
  },
