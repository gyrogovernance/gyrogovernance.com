# Gyro Governance Website Content
...
- **Website**: https://korompilias.github.io/
- **LinkedIn**: https://www.linkedin.com/in/korompilias
...
**ChatGPT 5:**
- Quality Index: 73.92% 
- Alignment Rate: 0.27/min (SUPERFICIAL: 8.7× deviation)
- SI Index: 11.5/100
...
- **GitHub**: https://github.com/gyrogovernance/science/tree/main/docs/datasets
...
- **HuggingFace**: https://huggingface.co/datasets/crisisresolutions/cr-qa-gwm
...
- **HuggingFace**: https://huggingface.co/datasets/crisisresolutions/gwm-qa-pure
...
- **Website**: https://crisisresolutions.github.io/
...
- **YouTube**: https://www.youtube.com/watch?v=xqYOGclAxA4&list=PLbiBCRZazXRlEuGP5cajZwcUEHlypmzpI
...
- **YouTube**: https://www.youtube.com/watch?v=F8bjhRSi0vo&list=PLGYNxF_pnQgv9WorsLMsTjJXWMGxWSnlX

#### Articles
*Featured articles carousel with links to all articles at /articles*
...
- 284× faster encode boundary, 1.15× faster decode
- Coherent text generation without transcendental functions at those surfaces
